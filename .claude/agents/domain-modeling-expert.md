...
- **fp:effect-ts**: For Effect-TS specific patterns
- **pauljphilp-effect-patterns-domain-modeling**: Effect-TS domain modeling
- **ojowwalker77-effect-ts-expert**: Effect-TS implementation
