"use client";
import { AlertOutlined, CheckCircleFilled, CheckCircleOutlined } from "@ant-design/icons";
...
export const ChatWindow = ({
  ...
  const { data: identity = user } = useGetIdentity<IUser>();
  ...
  const commonBubbleItemType: Partial<BubbleItemType> = useMemo((): Partial<BubbleItemType>  => {
    return {
