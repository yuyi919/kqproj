...
import { Card, Input, Button, List, Badge, Typography, Space, Divider, Tag } from "antd"
...
export default function SocketDebugPage() {
  const { isConnected, user, logs, joinRoom, sendMessage, clearLogs } = useSocket()
        ...
        <Space direction="vertical" style={{ width: "100%" }} size="large">
          ...
          <Card title="房间控制">
            <Space direction="vertical" style={{ width: "100%" }}>
              ...
              />
              <Button type="primary" onClick={handleJoin} block disabled={!isConnected}>
                加入房间
              </Button>
            </Space>
          </Card>
              ...
              <List.Item style={{ padding: "8px 0" }}>
                <div style={{ width: "100%" }}>
                  <Space style={{ marginBottom: "4px" }}>
                    <Tag color={
                      log.type.startsWith("emit") ? "blue" : 
                      log.type === "system" ? "orange" : 
