...
function processDroppedCards(
  ...
  // 分配手牌
  const distribution = distributeDroppedCards(droppedCards, claimerId, otherPlayers);
 ...
 * 应在每回合结算阶段调用
 */
export function resolveWreckTransformations(state: GameState): WreckResolution[] {
