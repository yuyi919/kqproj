...
export function getCardIcon(
  ...
  switch (type) {
    ...
    case 'barrier':
      return <SafetyOutlined style={{ ...iconStyle, color: token.colorSuccess }} />;
    case 'kill':
      return <FireOutlined style={{ ...iconStyle, color: token.colorError }} />;
    case 'detect':
      return <SearchOutlined style={{ ...iconStyle, color: token.colorInfo }} />;
    case 'check':
      return <ExperimentOutlined style={{ ...iconStyle, color: token.colorTextSecondary }} />;
    default:
      return null;
  }
}
    ...
    >
      ...
      <div style={{ marginTop: 'auto' }}>
        {isWitchKiller ? (
          ...
          <Tag style={{ ...config.tagSize, margin: 0 }}>
            消耗
          </Tag>
        ) : null}
      </div>
